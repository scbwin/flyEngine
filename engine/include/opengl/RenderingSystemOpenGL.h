...
namespace fly
{
  ...
  private:
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDepth;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDepthLayered;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDepthPointLight;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramScreen;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramGodRay;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDeferredGeometryTextured;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDeferredLightingDirectional;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDeferredLightingSpot;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDeferredLightingPoint;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramPingPongFilter;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramPingPongFilterBilateral;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramBloom;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramMotionBlur;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramLightGather;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramBrightness;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramSkybox;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramWaterForward;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramUnderwater;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramWaterPopupDistortion;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramExposure;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramVolumeLight;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramVolumeLightSpot;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramVolumeLightPoint;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramGradient;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDOF;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDOFGather;
    std::shared_ptr<GLShaderProgramOld> _shaderProgramDOFRefDepth;
   // std::shared_ptr<GLShaderProgram> _aabbShader;
    std::shared_ptr<GLShaderProgramOld> _lensFlareShader;
    std::shared_ptr<GLShaderProgramOld> _lensFlareCombineShader;
    std::shared_ptr<GLShaderProgramOld> _skydomeShader;
    std::shared_ptr<GLShaderProgramOld> _ssrShader;
    std::shared_ptr<GLShaderProgramOld> _terrainShader;
    std::shared_ptr<GLShaderProgramOld> _terrainWireframeShader;
    std::shared_ptr<GLShaderProgramOld> _normalMapShader;
    std::shared_ptr<GLShaderProgramOld> _grassShader;
    std::shared_ptr<GLShaderProgramOld> _treeShader;
    std::shared_ptr<GLShaderProgramOld> _impostorShader;
    std::shared_ptr<GLShaderProgramOld> _treeBillboardShader;
    std::shared_ptr<GLShaderProgramOld> _treeShadowMapShader;
    std::shared_ptr<GLShaderProgramOld> _leavesShader;
    std::shared_ptr<GLShaderProgramOld> _leavesShadowMapShader;
    std::shared_ptr<GLShaderProgramOld> _leavesImpostorShader;
    std::shared_ptr<GLShaderProgramOld> _cloudBillboardShader;
    std::shared_ptr<GLShaderProgramOld> _waterShader;
    std::shared_ptr<GLShaderProgramOld> _directionalLightShader;
    std::shared_ptr<GLShaderProgramOld> _waterPopUpDistortionShader;
    std::shared_ptr<GLShaderProgramOld> _underwaterShader;
    ...
    void createShader(std::shared_ptr<GLShaderProgramOld>& shader, const std::string& vs, const std::string& fs, const std::string& gs = "");
    void renderWater();
